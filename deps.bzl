...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:ZLktqqhPaoV9ZKGWTMDwivm+jBOcl2yrLJV3Qoqttz4=",
        version = "v2.32.0-RC1+incompatible",
    )
    go_repository(
        name = "com_github_apache_beam_sdks_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/apache/beam/sdks/v2",
        sum = "h1:TONrt8W57iQI7tPetsxR4eElu/tDfq7o3eYIpDYa7zc=",
        version = "v2.35.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Q27HxPAv+57FFR9povbiheKHbQh4THHFoKcUGBvDCyc=",
        version = "v1.13.0",
    )
    go_repository(
