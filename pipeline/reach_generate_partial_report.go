...
import (
	...
	"github.com/google/privacy-sandbox-aggregation-service/pipeline/reachbrowsersimulator"
)

var (
	reachFile          = flag.String("reach_file", "", "Input raw conversion data.")
...
func main() {
	...
	reachbrowsersimulator.GeneratePartialReport(scope, &reachbrowsersimulator.GeneratePartialReportParams{
		ReachFile:          *reachFile,
